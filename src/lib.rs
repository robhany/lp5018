...
impl LedDriver {
    ...
    where
        I2C: Write<Error = E> + WriteRead<Error = E>,
    {
        self.set_output(i2c, Out00, intensity)?;
        self.set_output(i2c, Out01, intensity)?;
        self.set_output(i2c, Out02, intensity)?;
        self.set_output(i2c, Out03, intensity)?;
        self.set_output(i2c, Out04, intensity)?;
        self.set_output(i2c, Out05, intensity)?;
        self.set_output(i2c, Out06, intensity)?;
        self.set_output(i2c, Out07, intensity)?;
        self.set_output(i2c, Out08, intensity)?;
        self.set_output(i2c, Out09, intensity)?;
        self.set_output(i2c, Out10, intensity)?;
        self.set_output(i2c, Out11, intensity)?;
        self.set_output(i2c, Out12, intensity)?;
        self.set_output(i2c, Out13, intensity)?;
        self.set_output(i2c, Out14, intensity)?;
        self.set_output(i2c, Out15, intensity)?;
        self.set_output(i2c, Out16, intensity)?;
        self.set_output(i2c, Out17, intensity)
    }

    pub fn set_output<I2C, E>(
        &self,
        i2c: &mut I2C,
        output_pin: Output,
        intensity: u8,
